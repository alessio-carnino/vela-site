export default function About() {
  return (
    <div id="studio" className="about-root">
      <div className="about-layout">
        ...
        <div className="about-text">
          ...
          <h2 style={{ fontWeight: 700, fontSize: 42, lineHeight: 1.15, letterSpacing: "-0.03em", marginBottom: 28 }}>
            A small team that designs, builds, and ships the whole thing.
          </h2>
          <p style={{ fontSize: 18, lineHeight: 1.6, color: "#5c5c5c", marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 18, lineHeight: 1.6, color: "#5c5c5c", marginBottom: 40 }}>
